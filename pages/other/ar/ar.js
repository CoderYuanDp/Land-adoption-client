...
Page({
  ...
  onLoad(e) {
    if(this.data.status_sproute) {
      glb = 'sproute'
    }else if(this.data.status_germinate){
      glb = 'germinate'
    }else if(this.data.status_grow){
      glb = 'grow'
    }else if(this.data.status_mature){
      glb = 'mature'
    }
    const glbObj = {
      sproute: 'https://dpweb.club:3000/1683707697581_scane1.glb',
      germinate: 'https://dpweb.club:3000/1683707698563_scane2.glb',
      grow: 'https://dpweb.club:3000/1683707699600_scane3.glb',
      mature: 'https://dpweb.club:3000/1683707700688_scane4.glb'
    }
    console.log(e.glb);
    if(e.glb) {
      this.setData({
